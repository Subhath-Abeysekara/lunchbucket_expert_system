...
Features = {
  ...
  "holiday" : {'No': 0, 'Yes': 1,'Nan':2}
}
Row_features = {
    "temperature" : 90,
    "pre_request": 0,
    "menu_matching_rate": 0,
    "last_menu_availability":0
}

input_data_limit = {
    "food_type" : "white rice",
    "meal" : "Dinner",
    "pre_request": 12,
    "last_menu_availability" : 13,
    "menu_matching_rate": 3.846154,
...
def prediction(input_data):
  ...
  print(datapoint)
  load_model = joblib.load('lb_limit_predict_model.h5')
  y_pred = load_model.predict(datapoint)
  print(y_pred[0])
  return y_pred[0]

# prediction(input_data_limit)